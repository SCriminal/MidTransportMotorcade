...
NSString *const kModelOrderOperateTimeItemCategoryId = @"categoryId";
...
//    [mutableDict setValue:[NSNumber numberWithDouble:self.categoryId] forKey:kModelOrderOperateTimeItemCategoryId];
