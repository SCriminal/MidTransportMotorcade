...
- (void)request{
    ...
    [RequestApi requestAddFeedbackWithBetter:self.textView2.text bad:self.textView.text app:@"2" teminalType:1 userId:[GlobalData sharedInstance].GB_UserModel.userId delegate:self success:^(NSDictionary * _Nonnull response, id  _Nonnull mark) {
