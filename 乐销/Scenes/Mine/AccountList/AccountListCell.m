...
- (void)resetCellWithModel:(id)model{
    ...
    //刷新view
    [self.labelPrice fitTitle:@"+200" variable:0];
    self.labelPrice.right = SCREEN_WIDTH -  W(15);

    [self.labelTitle fitTitle:@"加油费" variable:self.labelPrice.left - W(30) - (self.ivSelected.hidden?0:self.ivSelected.right)];
    self.labelTitle.leftTop = XY(self.ivSelected.hidden?W(15):self.ivSelected.right + W(15),W(20));
    
    [self.labelBillNo fitTitle:@"提单编号：223339900009999" variable:self.labelPrice.left - W(30)];
    self.labelBillNo.leftTop = XY(self.labelTitle.left,self.labelTitle.bottom+W(15));

    [self.labelTime fitTitle:@"记账时间：2019-03-14 12:2" variable:self.labelPrice.left - W(30)];
