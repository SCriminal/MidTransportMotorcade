...
- (void)resetViewWithModel:(id)model{
    ...
    
    {
        ...
        [self.viewBG addSubview:viewBorder];
        [viewBorder addTarget:self action:@selector(selectMotorcadeClick)];
    ...
    self.btnSearch.widthHeight = XY(W(335),W(45));
    self.btnSearch.centerXBottom = XY(self.viewBG.width/2.0,self.viewBG.height- W(20));
}
